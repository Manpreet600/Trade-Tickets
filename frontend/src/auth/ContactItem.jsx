...
function ContactItem({ contact, isSelected, onSelect }) {
  return (
    <button
      className="flex gap-3 items-center p-3 w-full text-left rounded-lg cursor-pointer border-[none] text-[white]"
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="overflow-hidden text-sm whitespace-nowrap text-ellipsis text-zinc-400">
          {contact.lastMessage}
        </div>
      </div>
      {contact.unread > 0 && (
